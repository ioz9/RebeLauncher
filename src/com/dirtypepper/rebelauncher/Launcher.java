...
import com.dirtypepper.rebelauncher.ActionButton.SwipeListener;
import com.dirtypepper.rebelauncher.DockBar.DockBarListener;
import com.dirtypepper.rebelauncher.catalogue.AppCatalogueFilter;
import com.dirtypepper.rebelauncher.catalogue.AppCatalogueFilters;
import com.dirtypepper.rebelauncher.catalogue.AppGroupAdapter;
import com.dirtypepper.rebelauncher.catalogue.AppInfoMList;
	...
	*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
		...
		//ADW: add custom settings
               menu.add(MENU_GROUP_NORMAL, MENU_ALMOSTNEXUS, 0, R.string.menu_rl_settings)
    ...
    private void openFolder(FolderInfo folderInfo) {
        ...
        if (folderInfo instanceof UserFolderInfo) {
            ...
            openFolder = com.dirtypepper.rebelauncher.LiveFolder.fromXml(this, folderInfo);
        } else {
            return;
        }
