...
public class MyLauncherSettings extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    private static final String PREF_BACKUP_FILENAME = "rl_settings.xml";
    private static final String CONFIG_BACKUP_FILENAME = "rl_launcher.db";
    private static final String NAMESPACE = "com.dirtypepper.rebelauncher";
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		Intent intent=new Intent("com.dirtypepper.rebelauncher.THEMES");
	...
	protected void onPause(){
		if(shouldRestart){
			if(Build.VERSION.SDK_INT<=7){
		        ...
		        acm.restartPackage("com.dirtypepper.rebelauncher");
			}else{
    ...
    public void getThemes(View v){
        ...
        try {
            ...
            Toast.makeText(this, R.string.activity_not_found, Toast.LENGTH_SHORT).show();
            e("RebeLauncher", "Launcher does not have the permission to launch " + marketIntent +
